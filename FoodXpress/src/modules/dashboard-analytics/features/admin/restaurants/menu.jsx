  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Total: {menuItems.length} items</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {menuItems.map((item) => (
            <Card key={item.menuItemId} style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }} className="border">
